...
**training website:** https://dib-lab.github.io/2020-NSURP/
...
Some thoughts on the bigger picture: coding and bioinformatics are still heavily white and male. Friendly, accessible training can help lower the barrier to entry, particularly for underrepresented groups, and is highly feasible over Zoom. I see this as one way to start building the culture I want to see in academia. But research training and exposure is a small piece of the puzzle and must be combined with systematic work combating white supremacy culture in academia.
...
Our training materials are available as a website (https://dib-lab.github.io/2020-NSURP; doi: [10.5281/zenodo.4041204](https://zenodo.org/record/4041204#.X3-T6S9h3OQ)). Let us know if you find them useful.
